###########################################################################
## Makefile generated for Simulink model 'control_bucle'. 
## 
## Makefile     : control_bucle.mk
## Generated on : Wed Apr 25 13:30:08 2018
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/control_bucle
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Sergio/UNIVER~1/Tercero/SEGUND~1/PROGRA~1/PRCTIC~1/Scorbot
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = control_bucle_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/control_bucle
...
INCLUDES_BUILDINFO = -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/control_bucle_ert_rtw -I$(START_DIR) -IC:/Sergio/UNIVER~1/Tercero/SEGUND~1/PROGRA~1/PRCTIC~1/LEGOEV~1/PRACTI~2 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_LMSTYPES_DIR)/../ -I$(EV3_LMS2012_DIR)/../ -I$(EV3_BYTECODES_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src
...
DEFINES_ = -DMODEL=control_bucle -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -D_RTT_LCD_=3
...
DEFINES_STANDARD = -DMODEL=control_bucle -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = control_bucle.o control_bucle_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o linuxinitialize.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_color_sensor.o driver_ev3_motor.o
...
%.o : $(START_DIR)/control_bucle_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/control_bucle_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

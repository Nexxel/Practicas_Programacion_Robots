...
this.def["control_bucle_DW"] = {file: "control_bucle_c.html",line:24,type:"var"};
this.def["control_bucle_M_"] = {file: "control_bucle_c.html",line:27,type:"var"};
this.def["control_bucle_M"] = {file: "control_bucle_c.html",line:28,type:"var"};
this.def["control_bucle_step"] = {file: "control_bucle_c.html",line:31,type:"fcn"};
this.def["control_bucle_initialize"] = {file: "control_bucle_c.html",line:204,type:"fcn"};
this.def["control_bucle_terminate"] = {file: "control_bucle_c.html",line:246,type:"fcn"};
this.def["DW_control_bucle_T"] = {file: "control_bucle_h.html",line:50,type:"type"};
this.def["ConstP_control_bucle_T"] = {file: "control_bucle_h.html",line:68,type:"type"};
this.def["P_control_bucle_T"] = {file: "control_bucle_types_h.html",line:25,type:"type"};
this.def["RT_MODEL_control_bucle_T"] = {file: "control_bucle_types_h.html",line:28,type:"type"};
this.def["control_bucle_P"] = {file: "control_bucle_data_c.html",line:24,type:"var"};
this.def["control_bucle_ConstP"] = {file: "control_bucle_data_c.html",line:55,type:"var"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["control_bucle_c.html"] = "../control_bucle.c";
	this.html2Root["control_bucle_c.html"] = "control_bucle_c.html";
	this.html2SrcPath["control_bucle_h.html"] = "../control_bucle.h";
	this.html2Root["control_bucle_h.html"] = "control_bucle_h.html";
	this.html2SrcPath["control_bucle_private_h.html"] = "../control_bucle_private.h";
	this.html2Root["control_bucle_private_h.html"] = "control_bucle_private_h.html";
	this.html2SrcPath["control_bucle_types_h.html"] = "../control_bucle_types.h";
	this.html2Root["control_bucle_types_h.html"] = "control_bucle_types_h.html";
	this.html2SrcPath["control_bucle_data_c.html"] = "../control_bucle_data.c";
	this.html2Root["control_bucle_data_c.html"] = "control_bucle_data_c.html";

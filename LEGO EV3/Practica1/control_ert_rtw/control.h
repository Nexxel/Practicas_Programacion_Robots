...
struct P_control_T_ {
  real_T CompareToConstant_const;      /* Mask Parameter: CompareToConstant_const
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 53
 ...
 *
 * '<Root>' : 'control'
 * '<S1>'   : 'control/Compare To Constant'
 * '<S2>'   : 'control/Display Rotation '
 * '<S3>'   : 'control/MATLAB Function'
 * '<S4>'   : 'control/Motor'
 * '<S5>'   : 'control/Motor1'
 * '<S6>'   : 'control/Display Rotation /Display'
 */

###########################################################################
## Makefile generated for Simulink model 'control'. 
## 
## Makefile     : control.mk
## Generated on : Wed Mar 21 14:29:25 2018
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = control_ref.rsp
...
INCLUDES_BUILDINFO = -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/control_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_LMSTYPES_DIR)/../ -I$(EV3_LMS2012_DIR)/../ -I$(EV3_BYTECODES_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src
...
DEFINES_ = -DMODEL=control -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -D_RTT_LCD_=1
...
DEFINES_STANDARD = -DMODEL=control -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = control.o control_data.o linuxinitialize.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_encoder.o driver_ev3_motor.o

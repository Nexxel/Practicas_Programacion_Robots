...
this.def["stopSem"] = {file: "ert_main_c.html",line:40,type:"var"};
this.def["baserateTaskSem"] = {file: "ert_main_c.html",line:41,type:"var"};
this.def["schedulerThread"] = {file: "ert_main_c.html",line:42,type:"var"};
this.def["baseRateThread"] = {file: "ert_main_c.html",line:43,type:"var"};
...
this.def["exitFcn"] = {file: "ert_main_c.html",line:64,type:"fcn"};
this.def["terminateTask"] = {file: "ert_main_c.html",line:70,type:"fcn"};
this.def["main"] = {file: "ert_main_c.html",line:91,type:"fcn"};
this.def["basicLineFollowing_M_"] = {file: "basicLineFollowing_c.html",line:24,type:"var"};
this.def["basicLineFollowing_M"] = {file: "basicLineFollowing_c.html",line:25,type:"var"};
this.def["basicLineFollowing_step"] = {file: "basicLineFollowing_c.html",line:29,type:"fcn"};
this.def["basicLineFollowing_initialize"] = {file: "basicLineFollowing_c.html",line:143,type:"fcn"};
this.def["basicLineFollowing_terminate"] = {file: "basicLineFollowing_c.html",line:170,type:"fcn"};
this.def["ConstP_basicLineFollowing_T"] = {file: "basicLineFollowing_h.html",line:56,type:"type"};
this.def["P_basicLineFollowing_T"] = {file: "basicLineFollowing_types_h.html",line:25,type:"type"};
this.def["RT_MODEL_basicLineFollowing_T"] = {file: "basicLineFollowing_types_h.html",line:28,type:"type"};
this.def["basicLineFollowing_P"] = {file: "basicLineFollowing_data_c.html",line:24,type:"var"};
this.def["basicLineFollowing_ConstP"] = {file: "basicLineFollowing_data_c.html",line:49,type:"var"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["basicLineFollowing_c.html"] = "../basicLineFollowing.c";
	this.html2Root["basicLineFollowing_c.html"] = "basicLineFollowing_c.html";
	this.html2SrcPath["basicLineFollowing_h.html"] = "../basicLineFollowing.h";
	this.html2Root["basicLineFollowing_h.html"] = "basicLineFollowing_h.html";
	this.html2SrcPath["basicLineFollowing_private_h.html"] = "../basicLineFollowing_private.h";
	this.html2Root["basicLineFollowing_private_h.html"] = "basicLineFollowing_private_h.html";
	this.html2SrcPath["basicLineFollowing_types_h.html"] = "../basicLineFollowing_types.h";
	this.html2Root["basicLineFollowing_types_h.html"] = "basicLineFollowing_types_h.html";
	this.html2SrcPath["basicLineFollowing_data_c.html"] = "../basicLineFollowing_data.c";
	this.html2Root["basicLineFollowing_data_c.html"] = "basicLineFollowing_data_c.html";
